...
namespace ConsoleBaseRPG_.Net8.UI
{
    internal class PlayerUI
    {
        ...
        {
            bool result = player.EquipArmor(item, out string message);
        ...
        { 
            bool result = player.EquipWeapon(item, out string message);
            Console.WriteLine(message);
            Console.ReadKey();
        }
        ...
        {
            Console.Clear();
            bool result = player.Heal(item, out string message);
            Console.WriteLine(message);
            Console.ReadKey();
        }
    }
